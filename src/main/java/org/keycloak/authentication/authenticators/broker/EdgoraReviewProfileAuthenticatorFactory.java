 ...
 */
public class EdgoraReviewProfileAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "edgora-idp-review-profile";
    static EdgoraIdpReviewProfileAuthenticator SINGLETON = new EdgoraIdpReviewProfileAuthenticator();
    ...
    public String getDisplayType() {
        return "Edgora IDP Review Profile";
    }
